...
public interface DropTarget {
    ...
    class DragObject {
         ...
         * differentiates onDragExit, since this is called when the drag is ending, above the
         * current drag target, or when the drag moves off the current drag object.
         */
     ...
     * @param xOffset Horizontal offset with the object being dragged where the original touch
     *        happened
     * @param yOffset Vertical offset with the object being dragged where the original touch
     *        happened
    ...
    /**
     * Check if a drop action can occur at, or near, the requested location. This will be called
     * just before onDrop.
     * 
     * @param source DragSource where the drag started
     * @param x X coordinate of the drop location
