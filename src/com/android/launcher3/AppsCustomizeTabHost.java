...
public class AppsCustomizeTabHost extends FrameLayout implements LauncherTransitionable, Insettable {
    ...
    /**
     * Convenience methods to select specific tabs. We want to set the content type immediately in
     * these cases, but we note that we still call setCurrentTabByTag() so that the tab view
