...
class AppWidgetManagerCompatVL extends AppWidgetManagerCompat {
    ...
    @Override
    public void startConfigActivity(AppWidgetProviderInfo info, int widgetId, Activity activity, AppWidgetHost host,
            int requestCode) {
        try {
    ...
    public Bitmap getBadgeBitmap(AppWidgetProviderInfo info, Bitmap bitmap) {
        ...
        Drawable drawable =
                mPm.getUserBadgedDrawableForDensity(new BitmapDrawable(res, bitmap), info.getProfile(), badgeLocation,
                        0);
