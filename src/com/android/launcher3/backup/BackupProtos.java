...
public interface BackupProtos {
		...
		public Key mergeFrom(
			...
			while (true) {
				...
				case 0:
					return this;
				default: {
					if (!com.google.protobuf.nano.WireFormatNano
							.parseUnknownField(input, tag)) {
						return this;
					}
					break;
				}
	...
	public static final class CheckedMessage extends
		...
		public static CheckedMessage parseFrom(byte[] data)
				throws com.google.protobuf.nano.InvalidProtocolBufferNanoException {
			return com.google.protobuf.nano.MessageNano.mergeFrom(
					new CheckedMessage(), data);
		}
		...
		public Journal mergeFrom(
			...
			while (true) {
				...
				case 42: {
					...
					com.android.launcher3.backup.BackupProtos.Key[] newArray = new com.android.launcher3.backup.BackupProtos.Key[i
							+ arrayLength];
					if (i != 0) {
	...
	public static final class Screen extends
		...
		public static Screen parseFrom(byte[] data)
				throws com.google.protobuf.nano.InvalidProtocolBufferNanoException {
			return com.google.protobuf.nano.MessageNano.mergeFrom(new Screen(),
					data);
		}
	...
	public static final class Widget extends
		...
		public static Widget parseFrom(byte[] data)
				throws com.google.protobuf.nano.InvalidProtocolBufferNanoException {
			return com.google.protobuf.nano.MessageNano.mergeFrom(new Widget(),
					data);
		}
