...
public class DynamicGrid {
    ...
    public DynamicGrid(Context context, Resources resources, int minWidthPx, int minHeightPx, int widthPx,
        ...
        deviceProfiles.add(new DeviceProfile("Shorter Stubby", 255, 400, 4, 4, ICON_SIZE_DP_SMALL, 13, (hasAA ? 5 : 4),
        ...
        deviceProfiles.add(new DeviceProfile("Stubby", 255, 450, 4, 4, ICON_SIZE_DP_SMALL, 13, (hasAA ? 5 : 4),
                ICON_SIZE_DP_SMALL, R.xml.default_workspace, R.xml.default_workspace_no_all_apps));
        deviceProfiles.add(new DeviceProfile("Nexus S", 296, 491.33f, 4, 4, ICON_SIZE_DP_SMALL, 13, (hasAA ? 5 : 4),
                ICON_SIZE_DP_SMALL, R.xml.default_workspace, R.xml.default_workspace_no_all_apps));
        deviceProfiles.add(new DeviceProfile("Nexus 4", 335, 567, 4, 4, DEFAULT_ICON_SIZE_DP, 13, (hasAA ? 5 : 4),
                DEFAULT_ICON_SIZE_DP, R.xml.default_workspace, R.xml.default_workspace_no_all_apps));
        deviceProfiles.add(new DeviceProfile("Nexus 5", 359, 567, 4, 4, DEFAULT_ICON_SIZE_DP, 13, (hasAA ? 5 : 4),
                DEFAULT_ICON_SIZE_DP, R.xml.default_workspace, R.xml.default_workspace_no_all_apps));
        deviceProfiles.add(new DeviceProfile("Large Phone", 406, 694, 4, 4, ICON_SIZE_DP_BIGGER, 14.4f, 4,
                ICON_SIZE_DP_BIGGER, R.xml.default_workspace, R.xml.default_workspace_no_all_apps));
        // The tablet profile is odd in that the landscape orientation
        // also includes the nav bar on the side
        deviceProfiles.add(new DeviceProfile("Nexus 7", 575, 904, 6, 6, ICON_SIZE_DP_BIGGER, 14.4f, (hasAA ? 7 : 6),
                ICON_SIZE_DP_BIGGER, R.xml.default_workspace, R.xml.default_workspace_no_all_apps));
        // Larger tablet profiles always have system bars on the top & bottom
        deviceProfiles.add(new DeviceProfile("Nexus 10", 727, 1207, 6, 6, ICON_SIZE_DP_BIGGER, 14.4f, (hasAA ? 7 : 6),
                ICON_SIZE_DP_BIGGER, R.xml.default_workspace, R.xml.default_workspace_no_all_apps));
