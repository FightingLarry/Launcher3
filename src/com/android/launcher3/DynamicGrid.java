...
public class DynamicGrid {
    ...
    public DynamicGrid(Context context, Resources resources, int minWidthPx, int minHeightPx, int widthPx,
        ...
        deviceProfiles.add(new DeviceProfile("Super Short Stubby", 255, 300, 4, 3, ICON_SIZE_DP_SMALL, 13, (hasAA
                ? 3
                : 3), ICON_SIZE_DP_SMALL, R.xml.default_workspace, R.xml.default_workspace_4x3_no_all_apps));
        ...
        deviceProfiles.add(new DeviceProfile("Short Stubby", 275, 420, 4, 3, ICON_SIZE_DP_SMALL, 13, (hasAA ? 5 : 4),
                ICON_SIZE_DP_SMALL, R.xml.default_workspace, R.xml.default_workspace_4x3_no_all_apps));
