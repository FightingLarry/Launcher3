        ...
        if (readingOrderGreaterThan(target, empty)) {
            ...
            for (int y = startY; y <= target[1]; y++) {
                ...
                for (int x = startX; x <= endX; x++) {
                    ...
                    if (mContent.animateChildToPosition(v, empty[0], empty[1], REORDER_ANIMATION_DURATION, delay, true,
                            true)) {
                        empty[0] = x;
                        empty[1] = y;
                        delay += delayAmount;
        ...
        Runnable onCompleteRunnable = new Runnable() {
            ...
            public void run() {
                ...
                if (getItemCount() == 1) {
                    ...
                    LauncherModel.addOrMoveItemInDatabase(mLauncher, finalItem, mInfo.container, mInfo.screenId,
                ...
                if (child != null) {
                    mLauncher.getWorkspace().addInScreenFromBind(child, mInfo.container, mInfo.screenId, mInfo.cellX,
